...
var $author$project$Website$init = function (_v0) {
...
var $author$project$Website$update = F2(
	function (msg, model) {
		var open = msg.a;
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{impressumIsOpen: open}),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Website$SetImpressumOpen = function (a) {
	return {$: 'SetImpressumOpen', a: a};
};
...
var $author$project$Website$downIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		_List_Nil,
		A2($1602$elm_feather$FeatherIcons$withSize, 14, $1602$elm_feather$FeatherIcons$chevronDown)));
...
var $author$project$Website$email = 'example@example.com';
...
var $author$project$Website$Image = function (a) {
	return {$: 'Image', a: a};
};
var $author$project$Website$Video = function (a) {
	return {$: 'Video', a: a};
};
var $author$project$Website$galleryTiles = _List_fromArray(
	[
...
var $1602$elm_feather$FeatherIcons$mail = A2(
	$1602$elm_feather$FeatherIcons$makeBuilder,
	'mail',
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$strokeLinecap('round'),
					$elm$svg$Svg$Attributes$strokeLinejoin('round'),
					$elm$svg$Svg$Attributes$class('feather feather-mail')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Website$mailIcon = $mdgriffith$elm_ui$Element$html(
	A2(
		$1602$elm_feather$FeatherIcons$toHtml,
		_List_Nil,
		A2($1602$elm_feather$FeatherIcons$withSize, 14, $1602$elm_feather$FeatherIcons$mail)));
...
var $author$project$Website$viewImpressum = A2(
	...
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$text('Max Musterman ist verantwortlich'),
			$mdgriffith$elm_ui$Element$text('70111 Stuttgart'),
			A2(
			$mdgriffith$elm_ui$Element$link,
			_List_Nil,
			{
				label: $mdgriffith$elm_ui$Element$text('E-Mail: ' + $author$project$Website$email),
				url: 'mailto:' + $author$project$Website$email
			}),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[$mdgriffith$elm_ui$Element$Font$bold]),
			$mdgriffith$elm_ui$Element$text('Es werden keine Daten gespeichert.'))
		]));
...
var $author$project$Website$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Font$typeface('Ropa'),
						$mdgriffith$elm_ui$Element$Font$sansSerif
					])),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb, 0.15, 0.15, 0.15)),
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					angle: 3.14 - (3.14 * 0.15),
					steps: _List_fromArray(
						[
							A4($mdgriffith$elm_ui$Element$rgba255, 255, 199, 0, 0.07),
							A4($mdgriffith$elm_ui$Element$rgba255, 255, 43, 43, 0.07)
						])
				})
			]),
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('Maseltov')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$alignLeft, $mdgriffith$elm_ui$Element$Font$strike]),
									$mdgriffith$elm_ui$Element$text('Meersburg')),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$alignLeft, $mdgriffith$elm_ui$Element$Font$strike]),
									$mdgriffith$elm_ui$Element$text('30. April 2020')),
									A2(
									$mdgriffith$elm_ui$Element$el,
									_List_fromArray(
										[
									...
									$mdgriffith$elm_ui$Element$text('Coronapause...'))
								]))
						])),
					A2(
					...
					A2($elm$core$List$map, $author$project$Website$viewMediaTile, $author$project$Website$galleryTiles)),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
						...
						[
								...
								[
									...
									_List_fromArray(
										[
											...
											model.impressumIsOpen ? $author$project$Website$viewImpressum : $mdgriffith$elm_ui$Element$none)
										]),
									{
										label: A2(
											$mdgriffith$elm_ui$Element$row,
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$el,
													_List_Nil,
													model.impressumIsOpen ? $author$project$Website$downIcon : $mdgriffith$elm_ui$Element$none),
													A2(
													$mdgriffith$elm_ui$Element$el,
													_List_Nil,
													$mdgriffith$elm_ui$Element$text('Impressum'))
												])),
										onPress: $elm$core$Maybe$Just(
											$author$project$Website$SetImpressumOpen(!model.impressumIsOpen))
									})
								])),
							A2(
							$mdgriffith$elm_ui$Element$Input$button,
								...
								[$mdgriffith$elm_ui$Element$alignLeft, $mdgriffith$elm_ui$Element$alignBottom]),
							{
								label: A2(
									...
									_List_fromArray(
										[
											A2($mdgriffith$elm_ui$Element$el, _List_Nil, $author$project$Website$mailIcon),
											A2(
											$mdgriffith$elm_ui$Element$link,
											_List_Nil,
											{
												label: $mdgriffith$elm_ui$Element$text('Kontakt'),
												url: 'mailto:' + $author$project$Website$email
											})
										])),
								onPress: $elm$core$Maybe$Just(
									$author$project$Website$SetImpressumOpen(false))
							})
						]))
				])));
};
var $author$project$Website$main = $elm$browser$Browser$element(
	{
		init: $author$project$Website$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Website$update,
		view: $author$project$Website$view
	});
_Platform_export({'Website':{'init':$author$project$Website$main(
